...
//const String _kGalleryAssetsPackage = 'lib';
...
final List<Section> allSections = <Section>[
  const Section(
    ...
    rightColor: _mariner,
    backgroundAsset: 'assets/shrine/products/sunnies.png',
//    backgroundAssetPackage: _kGalleryAssetsPackage,
  ...
  const Section(
    ...
    backgroundAsset: 'assets/shrine/products/lawn_chair.png',
//    backgroundAssetPackage: _kGalleryAssetsPackage,
    details: const <SectionDetail>[
      _seatingDetail,
      _seatingImageDetail,
  ...
  const Section(
    ...
    leftColor: _mySin,
    rightColor: _tomato,
    backgroundAsset: 'assets/shrine/products/lipstick.png',
//    backgroundAssetPackage: _kGalleryAssetsPackage,
    details: const <SectionDetail>[
      _decorationDetail,
  ...
  const Section(
    ...
    rightColor: _tomato,
    backgroundAsset: 'assets/shrine/products/helmet.png',
//    backgroundAssetPackage: _kGalleryAssetsPackage,
    details: const <SectionDetail>[
      _protectionDetail,
