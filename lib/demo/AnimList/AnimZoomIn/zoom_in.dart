...
class _MyHomePageState extends State<ZoomIn>  with SingleTickerProviderStateMixin {
  ...
  initState() {
    ...
    animation = new Tween(begin: 200.0, end: 300.0).animate(controller)
      ..addListener(() {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Zoom In Animation"),
      ),
      body: new Center(
        child: new Container(
